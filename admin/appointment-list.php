                ...
                <div class="container">
                    ...
                    <div class="row">
                        <?php
                            ...
                            echo "<thead><tr><th scope='col'>ID</th><th scope='col'>Forename</th><th scope='col'>Surname</th><th scope='col'>Email Address</th><th scope='col'>Phone Number</th><th scope='col'>Appointment Date</th><th scope='col'>Appointment Details</th><th scope='col'>Appointed Created</th></tr></thead>";
                            echo "<tbody>";
                            ...
                            try {
                                ...
                                $stmt = $conn->prepare("SELECT id, forename, surname, email, phonenumber, app_date, app_details, created_at FROM appointments");
                                $stmt->execute();
